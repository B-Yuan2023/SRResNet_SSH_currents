...
parser.add_argument("--dir_hr", type=str, default="../out2d_256", help="directory of hr dataset")
parser.add_argument("--up_factor", type=int, default=64, help="upscale factor") # match with dirs
